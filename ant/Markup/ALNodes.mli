...
value encode_node      : node_type -> partial_value;
value encode_node_list : list node_type -> partial_value;
value decode_node      : string -> unknown -> node_type;
value decode_node_list : string -> unknown -> list node_type;
