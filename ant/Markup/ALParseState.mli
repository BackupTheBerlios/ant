...
value unwrap_ps : string -> unknown -> (parse_state -> unit);
...
value ps_add_reference          : list unknown -> partial_value;
value ps_reference_exists       : list unknown -> partial_value;
value ps_lookup_reference       : list unknown -> partial_value;
value ps_fold_references        : list unknown -> partial_value;
value ps_store_old_references : unknown -> partial_value;
value ps_compare_references   : unknown -> unknown -> partial_value;
value ps_write_references       : unknown -> unknown -> partial_value;
...
value ps_add_gfx_command        : unknown -> unknown -> partial_value;
